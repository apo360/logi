<head>
    <!-- Adicione esses links no head do seu arquivo de layout -->
    ...
    <div class="row">
        ...
        <!-- small box -->
            <div class="small-box bg-navy">
                <div class="inner">
                    <h3>{{ count(App\Models\Processo::all()) }}</h3>
                    <p>Processos</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-navy">
                <div class="inner">
                    <h3>{{ count(App\Models\Customer::all()) }}</h3>
                    <p>Clientes</p>
                </div>
                <div class="icon">
        ...
        <!-- small box -->
            <div class="small-box bg-navy">
                <div class="inner">
                    <h3>{{ count(App\Models\Funcionario::all()) }}</h3>
                    <p>Funcionários</p>
                </div>
                <div class="icon">
                    <i class="ion ion-bag"></i>
